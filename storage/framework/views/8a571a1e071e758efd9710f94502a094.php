        ...
        <div class="login-card bg-white">
            ...
            <div class="bg-primary-600 py-6 px-8 text-center">
                <div class="flex items-center justify-center space-x-3">
                    <img src="<?php echo e(asset('image/sima1.png')); ?>" alt="SIMASTOK" class="h-20 w-20" />
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input id="email" name="email" type="email" autocomplete="email" required
                                ...
                                placeholder="alamat@email.com" value="<?php echo e(old('email')); ?>">
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\laravel-inventory-gudang\resources\views/auth/login.blade.php ENDPATH**/ ?>